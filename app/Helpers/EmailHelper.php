    ...
    public static function sendCertificateEmail($recipientEmail, $recipientName, $certificateNumber, $downloadUrl, $pdfContent)
    {
        try {
            ...
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                ...
                <p>Anda dapat mengunduh sertifikat Anda melalui tautan berikut:</p>
                <p><a href="' . $downloadUrl . '" style="background-color: #4CAF50; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">Unduh Sertifikat</a></p>
